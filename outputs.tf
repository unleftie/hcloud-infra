output "ip4" {
  ...
  value = {
    ...
    try(hcloud_server.server4[0].name, var.server_name4) = try(hcloud_server.server4[0].ipv4_address, null)
    try(hcloud_server.server5[0].name, var.server_name5) = try(hcloud_server.server5[0].ipv4_address, null)
...
output "ip6" {
  ...
  value = {
    ...
    try(hcloud_server.server4[0].name, var.server_name4) = try(hcloud_server.server4[0].ipv6_address, null)
    try(hcloud_server.server5[0].name, var.server_name5) = try(hcloud_server.server5[0].ipv6_address, null)
...
output "private_ip4" {
  ...
  value = {
    ...
    try(hcloud_server.server4[0].name, var.server_name4) = try(one(hcloud_server.server4[0].network[*]).ip, null)
    try(hcloud_server.server5[0].name, var.server_name5) = try(one(hcloud_server.server5[0].network[*]).ip, null)
